...
productsRouter.put("/:id", passport.authenticate("admin", optsForbidden), updateById);
productsRouter.delete("/:id", passport.authenticate("admin", optsForbidden), destroyById);
